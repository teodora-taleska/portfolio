...
const words = [
  ...
  { text: "Systems",          color: null,      top: -150, left:    0, delay: 0.4 },
  ...
  { text: "Vision",           color: null,      top:  -80, left: -170, delay: 1.4 },
];
  ...
  return (
    <>
      {words.map((w, i) => (
        ...
        >
          <div className="flex items-center justify-center rounded-full border border-th-fg/40 px-3 py-1 bg-th-fg/5 backdrop-blur-sm shadow-lg">
            <span
              className={w.color ? "" : "text-th-fg"}
              style={{
